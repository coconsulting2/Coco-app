...
const USERS = [
    { user: "Administrador", role: "Administrador", dept: "Dirección", first: "user", last: "coco" },
    { user: "N2", role: "N2", dept: "Dirección", first: "user", last: "coco" },
    { user: "N1", role: "N1", dept: "Operaciones", first: "user", last: "coco" },
    { user: "Solicitante", role: "Solicitante", dept: "Operaciones", first: "user", last: "coco" },
    { user: "Cuentas por pagar", role: "Cuentas por pagar", dept: "Operaciones", first: "user", last: "coco" },
    { user: "Agencia de viajes", role: "Agencia de viajes", dept: "Operaciones", first: "user", last: "coco" },
