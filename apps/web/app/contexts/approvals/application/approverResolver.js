 ...
 *
 * Refactor Fase 6: este service ya estaba DI-clean (recibe `db` injected).
 * El único uso de prisma directo era el wrapper conveniente, que se movió a
 * `infrastructure/approverResolverGlobal.js`. Usuario de la versión global:
 *
 *   import { resolveN1N2ApproversGlobal }
 *     from "~/contexts/approvals/infrastructure/approverResolverGlobal.js";
 */
const N1_NAME = "N1";
const N2_NAME = "N2";
