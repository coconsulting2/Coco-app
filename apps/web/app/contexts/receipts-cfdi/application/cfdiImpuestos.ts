 ...
 * @returns {boolean}
 */
export function isIvaTrasladoAcreditable(usoCfdi: any, codigoImpuesto: any) {
 ...
 */
export function buildImpuestosFromTaxesBreakdown(taxes: any, options: any = {}) {
 ...
 * @returns {number}
 */
export function sumIvaTrasladadoFromImpuestos(impuestos: any) {
    return roundMoney(
        (impuestos || [])
 ...
 * @returns {number}
 */
export function sumRetencionesFromImpuestos(impuestos: any) {
    return roundMoney(
        (impuestos || [])
 ...
 * @returns {boolean}
 */
export function impuestosNeedManualReview(impuestos: any) {
 ...
 * @returns {CfdiImpuestoLine[]}
 */
export function resolveImpuestosFromComprobante(cfdi: any) {
 ...
 */
export function resolveExtendedGlCatalogFromAccounts(accounts: any) {
 ...
 * @returns {GlCatalogResolved}
 */
export function resolveExtendedGlCatalog(request: any) {
 ...
 */
export function glAccountForImpuesto(imp: any, gl: any) {
 ...
 * @returns {boolean}
 */
export function cfdiTotalsAreCoherent(subtotal: any, descuento: any, impuestos: any, total: any) {
    const traslados = roundMoney(
        impuestos.filter((i) => i.tipo === "traslado").reduce((s, i) => s + i.importe, 0),
    );
 ...
 * @returns {number}
 */
export function resolveGastoBaseFromComprobante(cfdi: any) {
