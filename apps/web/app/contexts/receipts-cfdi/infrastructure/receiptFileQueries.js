 ...
 */
export async function findRequestIdForReceipt(receiptId) {
 ...
 */
export async function updateReceiptFiles(receiptId, data) {
 ...
 */
export async function findReceiptFileIds(receiptId) {
  return prisma.receipt.findUnique({
    where: { receiptId: Number(receiptId) },
    select: {
      pdfFileId: true,
 ...
 */
export async function findReceiptFileIdsForDelete(receiptId) {
  return prisma.receipt.findUnique({
    where: { receiptId: Number(receiptId) },
