...
const ComprobantesModel = {
   ...
   * @returns {Promise<Object|null>}
   */
  async findReceiptById(receiptId: any) {
   ...
   */
  async getSatValidationByReceiptId(receiptId: any) {
   ...
   * @returns {Promise<Object|null>}
   */
  async updateSatAcuseByReceiptId(receiptId: any, data: any) {
   ...
   */
  async createCfdi(receiptId: any, data: any) {
