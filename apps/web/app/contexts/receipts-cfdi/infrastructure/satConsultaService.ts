 ...
 * @returns {string}
 */
export function buildExpresionImpresa({ rfcEmisor, rfcReceptor, total, uuid, selloUltimos8 = null }: any) {
 ...
 */
export function normalizeConsultaResult(raw: any) {
 ...
 */
export async function consultarCfdiOnce(input: any) {
 ...
 */
export async function consultarCfdiWithRetries(input: any) {
  let lastErr;
 ...
 * @returns {Object}
 */
export function acuseToCfdiRow(acuse: any) {
  return {
