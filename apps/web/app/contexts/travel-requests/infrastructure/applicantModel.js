...
import { buildRequestWorkflowSnapshots } from "~/contexts/workflow/application/buildRequestWorkflowSnapshots.js";
import { applyRefundContextToRequest } from "~/contexts/refunds/application/applyRefundContext.js";
import { initialStatusFromLevels } from "~/contexts/workflow/application/workflowRulesEngine.js";
...
const Applicant = {
   ...
   */
  async findReceiptByCfdiUuid(normalizedUuid) {
