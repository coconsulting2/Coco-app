 ...
 * @description Bandeja N1/N2 — solicitudes pendientes de autorizar. Loader
 * llama `getApprovalInbox` del slice approvals (statusId=2 para N1, =3
 * para N2). Renderiza `AuthRequestsList` con la data mapeada.
 */
