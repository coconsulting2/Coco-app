...
import ExpensesDashboard from "~/shared/ui/ExpensesDashboard";


export function meta() {
  return [{ title: "Comprobar gastos — CocoConsulting" }];
}
  ...
  return (
    <section className="max-w-5xl mx-auto space-y-8">
      <header className="space-y-2">
        ...
        <h1 className="font-serif text-3xl md:text-4xl">Comprobar gastos</h1>
      </header>
      <ExpensesDashboard />
    </section>
  );
