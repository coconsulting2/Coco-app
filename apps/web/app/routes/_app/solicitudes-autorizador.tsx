  ...
  return (
    <section className="max-w-5xl mx-auto space-y-8">
      <header className="space-y-2">
        <p className="eyebrow text-xs uppercase tracking-widest text-[var(--color-ink-muted)]">Coco / Solicitudes</p>
        <h1 className="font-serif text-3xl md:text-4xl">Solicitudes</h1>
      </header>
      <AuthRequestsList />
    </section>
  );
